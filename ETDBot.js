...
(function() {
  ...
  roomHelpCommand = (function(_super) {
    ...
    roomHelpCommand.prototype.functionality = function() {
      ...
      msg1 = "Welcome to Eletro, Techno and Dubstep <3 ! Create a playlist and populate it with songs from either YouTube or Soundcloud.  ";
  ...
  downloadCommand = (function(_super) {
    ...
    downloadCommand.prototype.functionality = function() {
      ...
      msg += "https://www.facebook.com/groups/EDTplugdj/ ";
      msg += "https://www.facebook.com/EDTentertainment ";
      return API.sendChat(msg);
    };
